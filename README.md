About treepoem-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/treepoem-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9676&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/treepoem-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `treepoem` can be installed with `conda`:
...
```
mamba install treepoem
```

It is possible to list all of the versions of `treepoem` available on your platform with `conda`:
...
```
mamba search treepoem --channel conda-forge
```
...
mamba repoquery search treepoem --channel conda-forge

# List packages depending on `treepoem`:
mamba repoquery whoneeds treepoem --channel conda-forge

# List dependencies of `treepoem`:
mamba repoquery depends treepoem --channel conda-forge
```
